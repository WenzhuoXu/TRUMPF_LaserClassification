...
# set the dataloader
train_root = '/content/quality_mix_4_8.zip_files/train'
val_root = '/content/quality_mix_4_8.zip_files/val'
...
weights_dict = torch.load('/content/efficientnetb0.pth', map_location=device)
...
for epoch in range(EPOCH):
    ...
    torch.save(model.state_dict(), '/content/test_quality.pth')
...
torch.save(model.state_dict(), '/content/drive/MyDrive/test_quality_best.pth')
