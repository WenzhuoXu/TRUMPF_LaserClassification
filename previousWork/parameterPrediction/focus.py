...
# set the dataloader
train_root = '/content/focus_new.zip_files/train'
val_root = '/content/focus_new.zip_files/val'
...
for epoch in range(EPOCH):
    ...
    torch.save(model.state_dict(), '/content/test_focus.pth')
...
torch.save(model.state_dict(), '/content/drive/MyDrive/test_focus_best.pth')
