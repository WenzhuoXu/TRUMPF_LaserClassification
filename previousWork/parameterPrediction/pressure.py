...
# set the dataloader
train_root = '/content/pressure_new.zip_files/train'
val_root = '/content/pressure_new.zip_files/val'
...
for epoch in range(EPOCH):
    ...
    torch.save(model.state_dict(), '/content/test_pressure.pth')
...
torch.save(model.state_dict(), '/content/drive/MyDrive/test_pressure_best.pth')
