...
def validate(model, dataloader, logger, iteration, device, checkpoint=None):
    ...
    print('-' * 72)
    print("Validation  loss: {:.4f}, speed: {:.4f}\n".format(
        avg_loss, accuracy_quality))
...
class NeuralNetwork(nn.Module):
    ...
    def get_loss(self, net_output, ground_truth):
        ...
        loss = quality_loss
        return loss, {'quality': quality_loss}
...
if __name__ == '__main__':
    ...
    for epoch in range(start_epoch, N_epochs + 1):
        ...
        for batch in training_dataloader:
            ...
            loss_train.backward()
            optimizer.step()
        # print("prediction quality: {:.4f}".format(
        #     output['quality'][1],
        #     )
        # )

        # print("target quality: {:.4f}".format(
        #     target_labels['quality'][1],
        #     )
        # )

        print("epoch {:4d}, loss: {:.4f}, quality: {:.4f}".format(
            epoch,
